...
add_filter( 'woocommerce_enqueue_styles', 'wooStyles' );
/**
 ...
 */
function wooStyles( $enqueue_styles ) {
...
add_action( 'wp_enqueue_scripts', 'wooCSS' );
/**
...
function wooCSS() {
	...
	if ( $woo_css ) {
		wp_add_inline_style( 'theme-woocommerce-styles', $woo_css );
	}
